...
fetch(
  ...
  .then((data) => {
    ...
    document
      ...
      .append(`${data.biography["full-name"]}`);
    document
      .getElementById("place")
      .append(`${data.biography["place-of-birth"]}`);
    document
      .getElementById("first-appearance")
      .append(`${data.biography["first-appearance"]}`);
    ...
    document
      ...
      .append(`${data.powerstats.intelligence}`);
    ...
    document
      ...
      .append(`${data.powerstats.durability}`);
    ...
    document
      .getElementById("eye-color")
      .append(`${data.appearance["eye-color"]}`);
    document
      .getElementById("hair-color")
      .append(`${data.appearance["hair-color"]}`);
    ...
    document
      ...
      .append(`${data.connections.relatives}`);
    document
      .getElementById("group-affiliation")
      .append(`${data.connections["group-affiliation"]}`);
  });
